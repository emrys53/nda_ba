...
namespace nda {
...
#else
      const simd_i4::intrinsic_t lo = _mm_add_epi32(_mm256_extractf128_si256(value, 0), _mm256_extractf128_si256(other.value, 0));
      const simd_i4::intrinsic_t hi = _mm_add_epi32(_mm256_extractf128_si256(value, 1), _mm256_extractf128_si256(other.value, 1));
...
#else
      const simd_i4::intrinsic_t lo = _mm_sub_epi32(_mm256_extractf128_si256(value, 0), _mm256_extractf128_si256(other.value, 0));
      const simd_i4::intrinsic_t hi = _mm_sub_epi32(_mm256_extractf128_si256(value, 1), _mm256_extractf128_si256(other.value, 1));
      return simd_type { _mm256_insertf128_si256(_mm256_castsi128_si256(lo), (hi), 1) }
#endif
    }
...
#else
      const simd_i4::intrinsic_t lo = _mm_mullo_epi32(_mm256_extractf128_si256(value, 0), _mm256_extractf128_si256(other.value, 0));
      const simd_i4::intrinsic_t hi = _mm_mullo_epi32(_mm256_extractf128_si256(value, 1), _mm256_extractf128_si256(other.value, 1));
      return simd_type{_mm256_insertf128_si256(_mm256_castsi128_si256(lo), (hi), 1)};
#endif
    }
  ...
  class simd_type<int64_t, 4, abi_tag::AVX> {
...
#else
      const simd_l2::intrinsic_t lo = _mm_add_epi64(_mm256_extractf128_si256(value, 0), _mm256_extractf128_si256(other.value, 0));
      const simd_l2::intrinsic_t hi = _mm_add_epi64(_mm256_extractf128_si256(value, 1), _mm256_extractf128_si256(other.value, 1));
      return simd_type{_mm256_insertf128_si256(_mm256_castsi128_si256(lo), (hi), 1)};
#endif
    }
...
#else
      const simd_l2::intrinsic_t lo = _mm_sub_epi64(_mm256_extractf128_si256(value, 0), _mm256_extractf128_si256(other.value, 0));
      const simd_l2::intrinsic_t hi = _mm_sub_epi64(_mm256_extractf128_si256(value, 1), _mm256_extractf128_si256(other.value, 1));
      return simd_type{_mm256_insertf128_si256(_mm256_castsi128_si256(lo), (hi), 1)};
#endif
    }
    ...
    simd_type operator*(const simd_type &other) const {
      ...
      return simd_type{_mm256_mullo_epi64(value, other.value)};
#else
#ifdef __AVX2__
      intrinsic_t upper32_a = _mm256_srli_epi64(value, 32);
      intrinsic_t upper32_b = _mm256_srli_epi64(other.value, 32);

      // upper * lower
      intrinsic_t mul1 = _mm256_mul_epu32(upper32_a, other.value);
      intrinsic_t mul2 = _mm256_mul_epu32(upper32_b, value);
      // Gives us both upper*upper and lower*lower
      intrinsic_t mul3 = _mm256_mul_epu32(value, other.value);

      intrinsic_t high = _mm256_slli_epi64(_mm256_add_epi64(mul1, mul2), 32);
  ...
  class simd_type<std::complex<float>, 4, abi_tag::AVX> {
    ...
    simd_type operator*(const simd_type &other) const {
       ...
       *
       */
      intrinsic_t tmp1 = _mm256_mul_ps(_mm256_movehdup_ps(value), _mm256_permute_ps(other.value, NDA_SHUFFLE_MASK4(1, 0, 3, 2)));
      intrinsic_t tmp2 = _mm256_moveldup_ps(value);
#ifdef __FMA__
      __m256 result = _mm256_fmaddsub_ps(tmp2, other.value, tmp1);
#else
      intrinsic_t result = _mm256_addsub_ps(_mm256_mul_ps(tmp2, other.value), tmp1);
#endif
    ...
    simd_type operator/(const simd_type &other) const {
      ...
      simd_type conj         = simd_type{_mm256_xor_ps(other.value, mask)};
      simd_type upper        = (*this) * conj;
      intrinsic_t flip       = _mm256_permute_ps(other.value, NDA_SHUFFLE_MASK4(1, 0, 3, 2));
#ifdef __FMA__
      intrinsic_t lower = _mm256_fmadd_ps(other.value, other.value, _mm256_mul_ps(flip, flip));
#else
      intrinsic_t lower = _mm256_add_ps(_mm256_mul_ps(other.value, other.value), _mm256_mul_ps(flip, flip));
#endif
  ...
  class simd_type<std::complex<double>, 2, abi_tag::AVX> {
    ...
    simd_type operator-(const simd_type &other) const { return simd_type{_mm256_sub_pd(value, other.value)}; }
    simd_type operator*(const simd_type &other) const {
      intrinsic_t tmp1 = _mm256_mul_pd(_mm256_permute_pd(value, 0xF), _mm256_permute_pd(other.value, 0x5));
      intrinsic_t tmp2 = _mm256_movedup_pd(value);
#ifdef __FMA__
      intrinsic_t result = _mm256_fmaddsub_pd(tmp2, other.value, tmp1);
#else
      intrinsic_t result = _mm256_addsub_pd(_mm256_mul_pd(tmp2, other.value), tmp1);
#endif
      return simd_type{result};
    }
    simd_type operator/(const simd_type &other) const {
      ...
      simd_type conj         = simd_type{_mm256_xor_pd(other.value, mask)};
      simd_type upper        = (*this) * conj;
      intrinsic_t flip       = _mm256_permute_pd(other.value, 0x5);
#ifdef __FMA__
      intrinsic_t lower = _mm256_fmadd_pd(other.value, other.value, _mm256_mul_pd(flip, flip));
#else
      intrinsic_t lower = _mm256_add_pd(_mm256_mul_pd(other.value, other.value), _mm256_mul_pd(flip, flip));
#endif
